...
public class TextViewLinkActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.text_view_link_activity);
        ...
        //创建一个 SpannableString对象
        final String userName = "王者$txt";
        String desc1 = "贡献给主人";
        String count = "10";
        String desc2 = "个礼物";
        final String giftName = "小星星";
        int totalLength = userName.length() + desc1.length() + count.length() + desc2.length() + giftName.length();
        msp1 = new SpannableString(userName+desc1+count+desc2+giftName);
//        msp1.setSpan(new ForegroundColorSpan(getResources().getColor(R.color.text_blue)), 0, userName.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        msp1.setSpan(new ClickableSpan() {
            @Override
            public void onClick(View widget) {
                Toast.makeText(TextViewLinkActivity.this, userName, Toast.LENGTH_SHORT).show();
            }
...
//        msp1.setSpan(new ForegroundColorSpan(getResources().getColor(R.color.text_blue)), totalLength-giftName.length(), totalLength, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        msp1.setSpan(new ClickableSpan() {
            @Override
            public void onClick(View widget) {
                Toast.makeText(TextViewLinkActivity.this, giftName, Toast.LENGTH_SHORT).show();
            }
        ...
        }, totalLength - giftName.length(), totalLength, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);

        mTextView.append(msp1);
